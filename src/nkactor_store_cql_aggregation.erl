...
-module(nkactor_store_cql_aggregation).
-author('Carlos Gonzalez <carlosj.gf@gmail.com>').
-export([aggregation/2]).
-import(nkactor_store_cql, [query/2, query/3, quote/1, quote_list/1, filter_path/2]).
...
aggregation(actors_aggregation_groups, Params) ->
    ...
    {query, Query, fun cassandra_aggregation/2};
...
%% @private
cassandra_aggregation([{{select, _Size}, Rows, _OpMeta}], Meta) ->
